            ...
            <div class="login-container">
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="form-group form-group-default" id="emailGroup">
                        <label>introduce tu usuario/email/telefono</label>
                        <div class="controls">
                            <input type="text" name="user" id="email" value="{{ old('user') }}" placeholder="{{ __('voyager::generic.email') }}" class="form-control" required>
                         </div>
                    </div>
