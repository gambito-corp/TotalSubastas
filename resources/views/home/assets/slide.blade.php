<div class="top-slide pt-5 mb-5 col-md-12 col-sm-12 col-xs-12">
        <div class="a ml-3 ">
		...
		<div class="carousel-inner redondo-5">
				...
				<span class="text-light pt-1 live-today">
                  Hoy
					  ...
					  <figure class="heading-carousel ">
						...
						<img class="carousel-item-a_imagen" src="./assets/img/image-205.png" height="499px"
          ...
          <article class="">
            ...
            <span class="d-flex justify-content-center text-light pb-3">
              <svg class="bi bi-download mr-2 fa-download" width="16px" height="16px" viewBox="0 0 16 16" fill="currentColor"
          ...
          <strong class="text-light d-flex justify-content-center pt-3">Regalamos 20$</strong>
          ...
          <div class="input-group mb-3 no-border border-0 pr-3 pl-3">
            <input type="text" class="form-control" placeholder="Ingresa tu email" aria-label="Recipient's username"
