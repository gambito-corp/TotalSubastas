...
{{--        </div>--}}
        ...
        <div class="row mt-5 container-slider">
            <div class="carousel slide col-6" id="carouselExampleIndicators" data-ride="carousel">
                <ol class="carousel-indicators" style="opacity: 0.5;">
                    <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li>
        ...
        <div class="mt-2">
            <div class="col-md-12 mt-3 pr-0 container-resultado">
                <div class="row">
                        ...
                        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                                <li class="nav-item active">
                                    <a class="nav-link title-to_results" href="#">hay 453    Resultados
