            ...
            <div class="row">
                ...
                <div class="container">
                    <div class="main-container row">
                            ...
                            @endphp
                                ...
                                <div class="col-md col-md-12 mb-3 pl-0 pr-0">
                                    <nav class="navbar navbar-expand-lg pb-0 pt-0 nav-top_main-content mb-2 border-bottom">
                                        <a class="navbar-brand text-darken" href="#">hola</a>
                                            ...
                                            <article class="ml-3">
                                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                    <label class="btn btn-light active">
                                                        <a href="#multi-item-example" data-slide="next"><i class="fas fa-caret-left"></i></a>
                                                    </label>
                                                    <label class="btn btn-light">
                                                        <a href="#multi-item-example" data-slide="next" ><i class="fas fa-caret-right"></i></a>
                                                    </label>
                                                </div>
                                            </article>
                                        </div>
                        ...
                        {{-- MODAL DE RESULTADOS NO SE POR QUE SE INCLUYO--}}
                        ...
                        {{-- FIN DEL MODAL DE RESULTADOS NO SE POR QUE SE INCLUYO--}}
                        {{-- FIN DEL CUADRO DE RESULTADOS--}}
                    <!-- -->
                    </div>
                </div>
            </div>
