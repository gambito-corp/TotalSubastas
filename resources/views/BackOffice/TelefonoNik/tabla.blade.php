...
@endsection
@section('fuentes')
@section('content_header', 'Control de Telefonos')
@section('BreadCrumbs', 'Rol')


@section('contenido')
    <h2>Visualiza Todos Los Telefonos {{ request()->routeis('rol.index') ? 'Que hay': 'Borrados' }}</h2>
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">Listado de Telefonos {{ request()->routeis('rol.index') ? 'Activos': 'Dados de Baja' }}</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
