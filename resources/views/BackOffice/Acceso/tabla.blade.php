...
@section('content')
    ...
    <a href="{{ route('Acceso.create') }}" class="btn btn-success">Nuevo Acceso</a>
    <br><br>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                @if (request()->routeis('Acceso.trash'))
                    <button class="btn btn-info btn-xs" data-toggle="modal" data-target="#modal-info_{{ $data->id }}">
            ...
            <div class="modal fade" id="modal-info_{{ $data->id }}">
                <div class="modal-dialog">
                    <div class="modal-content bg-info">
                        ...
                        <div class="modal-body">
                            <p>{{ "Deseas Actualizar el Acceso $data->nombre" }}</p>
                        </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-outline-light" data-dismiss="modal">Cerrar</button>
                            <a href="{{route('Acceso.edit', ['acceso' => $data])}}" class="btn btn-outline-light">Actualizar</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="modal-warning_{{ $data->id }}">
                <div class="modal-dialog">
                    <div class="modal-content bg-warning">
                        <div class="modal-header">
                            <h4 class="modal-title">Dar de Baja al Acceso {{ $data->nombre }}</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <p>Si das de baja al Acceso {{ $data->nombre }} este no podra acceder a la intranet hasta que decidas volver a darlo de alta en la plataforma</p>
                        </div>
                        <div class="modal-footer justify-content-between">
            ...
            <div class="modal fade" id="modal-info_{{ $data->id }}">
                <div class="modal-dialog">
                    <div class="modal-content bg-info">
                        ...
                        <div class="modal-body">
                            <p>Deseas Restaurar al Acceso {{ $data->nombre }} </p>
                        </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-outline-light" data-dismiss="modal">Cerrar</button>
            ...
            <div class="modal fade" id="modal-danger_{{ $data->id }}">
                <div class="modal-dialog">
                    <div class="modal-content bg-danger">
                        ...
                        <div class="modal-body">
                            <p>Esto eliminara al Acceso {{ $data->nombre }} de forma irrecuperable una vez presionado y confirmado el boton eliminar no hay marcha atras <br> desear eliminar al {{ $data->nombre }}</p>
                        </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-outline-light" data-dismiss="modal">Cerrar</button>
            ...
            <div class="modal fade" id="modal-danger-confirmacion_{{ $data->id }}">
                <div class="modal-dialog">
                    <div class="modal-content bg-danger">
                        ...
                        <div class="modal-body">
                            <p>100% Seguro de eliminar al Acceso  {{ $data->nombre }}, Podrias generar un fallo en cascada de hacerlo</p>
                        </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-outline-light" data-dismiss="modal">Cerrar</button>
                            <form action="{{ route('Acceso.destroy', $data) }}" method="post">
                                @csrf @method('DELETE')
        ...
        <tr>
            <td>No Existe id</td>
            <td>No Existe Rol</td>
            <td>No Existe Modelo</td>
            <td>No Existe Metodo</td>
            <td>No Existe Creado</td>
            <td>No Existe Actualizado</td>
            <td>No Existe Borrado</td>
            <td>No Existe Acciones</td>
        </tr>
        @endforelse
    </tbody>
    <tfoot>
