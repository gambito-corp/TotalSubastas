...
{{--  ---------------------------------------------------------  --}}
<header class="sticky bg-white flex" id="cabecera">
    <div>
        <img src="{{asset('assets/img/Icon-Phone.svg')}}"
             class="mr-2"
        >
    </div>
    <div>
        <a
            href="https://api.whatsapp.com/send?phone=51983521436&text=Quiero%20informacion%20de%20Total%20Subastas"
            class="navbar-brand d-flex text-dark align-items-center"
            target="_blank"
        >
            (+51) 983 521 436
        </a>
    ...
    <div class="ml-4">
        <img src="{{asset('assets/img/Imagen 1.png')}}">
    </div>
    <div>
        <a
            href="https://api.whatsapp.com/send?phone=51983521436&text=Quiero%20informacion%20de%20Total%20Subastas"
    ...
    <div>
        <div class="">
            <img src="{{asset('img/iconos/Icon-Key.svg')}}" class="" alt="">
        </div>
        <div class="">
