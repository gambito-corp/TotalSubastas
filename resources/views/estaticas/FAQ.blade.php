...
<div class="container-fluid">
  ...
  <div class="container">
    <div class="row" id="app">
          ...
          <div class="bg-light-card topics shadow-sm ">
            <div class="card-body">
              ...
              <ul class="nav">
                ...
                <router-link to="/foo">
                  <li class="nav-link text-darken-flat text-nav_faqs">
                    <i class="fas fa-file mr-2"> </i>Go to Foo </li>
                </router-link>
                <router-link to="/bar">
                  <li class="nav-link text-darken-flat text-nav_faqs">
                    <i class="fas fa-file mr-2"> </i>Go to Bar </li>
                </router-link>
              </ul>
            </div>
          </div>
      ...
      <div class="col-md col-md-9 order-md-2 mt-5" id="app">
